...
int insertar_primero(lista_t* lista, nodo_t* nodo){
	lista->primero = nodo;
	lista->ultimo = nodo;
	lista->cantidad++;
 ...
 */
int insertar(lista_t* lista, nodo_t* nodo, size_t posicion){
